...
impl TaskControlBlock {
    ...
    pub fn new(
        ...
        let mutex_n = process_inner.mutex_list.len();
        let sem_n = process_inner.semaphore_list.len();
        ...
        Self {
            ...
            inner: unsafe {
                UPSafeCell::new(TaskControlBlockInner {
                    ...
                    exit_code: None,
                    mutex_alloc: vec![0;mutex_n],
                    mutex_need: vec![0;mutex_n],
                    sem_alloc: vec![0;sem_n],
                    sem_need: vec![0;sem_n],
                })
            },
        }
    }
